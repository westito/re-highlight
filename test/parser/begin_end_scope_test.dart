...
void main() {
  ...
  setUpAll(() {
    final Mode grammar = Mode(
      contains: [
        ...
        Mode(begin: 'dumb', end: 'luck', beginScope: 'red', endScope: 'green'),
        Mode(
          begin: 'abc',
          beginScope: 'letters',
          contains: [Mode(match: 'def', scope: 'more')],
        ),
      ],
    );
  ...
  group('beginScope and endScope', () {
    test('should support multi-class', () {
      ...
      expect(
        result.toHtml(),
        '123 <span class="hljs-apple">a</span><span class="hljs-boy">b</span>c<span class="hljs-delta">d</span>',
      );
    });
    ...
    test('should support textual beginScope & endScope pair', () {
      ...
      expect(
        result.toHtml(),
        '<span class="hljs-red">dumb</span> really <span class="hljs-green">luck</span>',
      );
    });
    test('should support textual beginScope', () {
      ...
      expect(
        result.toHtml(),
        '<span class="hljs-letters">abc</span><span class="hljs-more">def</span>',
      );
    });
  });
}
