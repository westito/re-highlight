...
final langSwift = Mode(
  refs: {
    ...
    '~contains~2~contains~0~contains~2~contains~5~contains~2': Mode(
      ...
      className: <int, String>{2: 'keyword'},
    ),
    ...
    '~contains~2~contains~1~contains~14~contains~4~variants~0~contains~1': Mode(
      begin: "\\[",
      end: "\\]",
      relevance: 0,
    ...
    '~contains~2~contains~1~contains~14~contains~4': Mode(
      scope: 'regexp',
      variants: <Mode>[
        Mode(
          begin: "###\\/",
  ...
  contains: <Mode>[
    ...
    Mode(
      ...
      className: <int, String>{1: 'keyword', 3: 'title.function'},
      contains: <Mode>[
    ...
    Mode(
      ...
      className: <int, String>{1: 'keyword'},
      contains: <Mode>[
        Mode(ref: '~contains~2~contains~0'),
        Mode(ref: '~contains~2~contains~1'),
        Mode(ref: '~contains~2~contains~2'),
    ...
    Mode(
      ...
      scope: <int, String>{1: 'keyword', 3: 'keyword', 5: 'title.function'},
    ),
    Mode(
      match: ["class\\b", "\\s+", "var\\b"],
      scope: <int, String>{1: 'keyword', 3: 'keyword'},
    ),
    Mode(
      begin: [
      ...
      beginScope: <int, String>{1: 'keyword', 3: 'title.class'},
      keywords: {
        "\$pattern": "(?:\\b\\w+|#\\w+)",
        "keyword": [
          "actor",
    ...
    Mode(
      ...
      className: <int, String>{1: 'keyword', 3: 'title'},
    ),
    Mode(
      begin: [
        "precedencegroup",
      ...
      className: <int, String>{1: 'keyword', 3: 'title'},
      contains: <Mode>[Mode(ref: '~contains~2~contains~0~contains~2')],
      keywords: [
        "assignment",
        "associativity",
        "higherThan",
