...
final langYaml = Mode(
  refs: {
        ...
        Mode(
          ...
          contains: <Mode>[
            ...
            Mode(
              ...
              contains: <Mode>[
                Mode(match: "''", scope: 'char.escape', relevance: 0),
              ],
            ),
            Mode(
              className: 'string',
    ...
    '~contains~15~contains~0~contains~17': Mode(
      ...
      contains: <Mode>[Mode(match: "''", scope: 'char.escape', relevance: 0)],
    ),
  ...
  contains: <Mode>[
    ...
    Mode(ref: '~contains~15~contains~0~contains~17'),
    Mode(
      className: 'string',
      relevance: 0,
      variants: <Mode>[
      ...
      contains: <Mode>[
        BACKSLASH_ESCAPE,
        Mode(ref: '~contains~15~contains~0~contains~18~contains~1'),
      ],
    ),
  ],
);
