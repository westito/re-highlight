...
final langPhp = Mode(
  refs: {
    ...
    '~contains~0~contains~0~contains~2': Mode(
      variants: <Mode>[
        Mode(
          ...
          scope: <int, String>{2: 'variable.constant'},
        ),
        Mode(
          match: ["::", "class"],
          scope: <int, String>{2: 'variable.language'},
        ),
        Mode(
          match: [
          ...
          scope: <int, String>{1: 'title.class', 3: 'variable.constant'},
        ),
        Mode(
          match: [
            "(\\\\?[A-Z][a-z0-9_\\x7f-\\xff]+|\\\\?[A-Z]+(?=[A-Z][a-z0-9_\\x7f-\\xff])){1,}(?![A-Za-z0-9])(?![\$])",
        ...
        Mode(
          ...
          scope: <int, String>{1: 'title.class', 3: 'variable.language'},
        ),
      ],
    ),
    ...
    '~contains~0~contains~0~contains~6': Mode(
      variants: <Mode>[
        Mode(
          ...
          scope: <int, String>{1: 'keyword', 4: 'title.class'},
        ),
      ],
    ),
    '~contains~7': Mode(
    ...
    '~contains~8': Mode(
      ...
      scope: <int, String>{3: 'title.function.invoke'},
      contains: <Mode>[
        Mode(
          relevance: 0,
          begin: "\\(",
  ...
  contains: <Mode>[
    ...
    Mode(
      ...
      starts: Mode(
        ...
        contains: <Mode>[Mode(match: "\\?>", scope: 'meta', endsParent: true)],
      ),
    ),
    Mode(
      scope: 'meta',
    ...
    Mode(
      ...
      scope: <int, String>{1: 'keyword', 3: 'variable.constant'},
    ),
    Mode(ref: '~contains~0~contains~0~contains~6'),
    Mode(
      scope: 'function',
