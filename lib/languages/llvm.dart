...
final langLlvm = Mode(
  ...
  keywords: {
    ...
    "type":
        "void half bfloat float double fp128 x86_fp80 ppc_fp128 x86_amx x86_mmx ptr label token metadata opaque",
  },
  contains: <Mode>[
    ...
    Mode(
      ...
      contains: <Mode>[Mode(className: 'char.escape', match: "\\\\\\d\\d")],
    ),
    Mode(
      className: 'title',
      variants: <Mode>[
