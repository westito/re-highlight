...
final langRuby = Mode(
  refs: {
        ...
        Mode(
          ...
          contains: <Mode>[
            ...
            Mode(
              ...
              scope: <int, String>{2: 'title.class'},
              keywords: {
                "variable.constant": ["__FILE__", "__LINE__", "__ENCODING__"],
                "variable.language": ["self", "super"],
                "keyword": [
            ...
            Mode(
              ...
              scope: <int, String>{1: 'title.class'},
            ),
            Mode(
              relevance: 0,
                      ...
                      contains: <Mode>[
                        Mode(
                          ...
                          contains: <Mode>[
                            BACKSLASH_ESCAPE,
                            Mode(
                              ref: '~contains~1~starts~contains~0~contains~1',
                            ),
                          ],
                          illegal: "\\n",
                          variants: <Mode>[
    ...
    '~contains~1~starts~contains~0~contains~1~contains~1': Mode(
      ...
      scope: <int, String>{2: 'title.class', 4: 'title.class.inherited'},
      keywords: {
        "variable.constant": ["__FILE__", "__LINE__", "__ENCODING__"],
        "variable.language": ["self", "super"],
        "keyword": [
          ...
          contains: <Mode>[
            Mode(
              ...
              contains: <Mode>[
                Mode(ref: '~contains~1~starts~contains~0'),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~1',
                ),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~2',
                ),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~3',
                ),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~4',
                ),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~5',
                ),
                Mode(
                  ref: '~contains~1~starts~contains~0~contains~1~contains~6',
                ),
                Mode(begin: "[a-zA-Z]\\w*::"),
                Mode(
                  className: 'symbol',
