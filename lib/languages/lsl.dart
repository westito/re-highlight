...
final langLsl = Mode(
  ...
  contains: <Mode>[
    Mode(
      ...
      contains: <Mode>[Mode(className: 'subst', begin: "\\\\[tn\"\\\\]")],
    ),
    Mode(
      className: 'comment',
      variants: <Mode>[
    ...
    Mode(
      className: 'literal',
      variants: <Mode>[
        Mode(begin: "\\b(PI|TWO_PI|PI_BY_TWO|DEG_TO_RAD|RAD_TO_DEG|SQRT2)\\b"),
        Mode(
          begin:
        ...
        Mode(begin: "\\b(FALSE|TRUE)\\b"),
        Mode(begin: "\\b(ZERO_ROTATION)\\b"),
        Mode(
          begin:
        ...
        Mode(begin: "\\b(ZERO_VECTOR|TOUCH_INVALID_(TEXCOORD|VECTOR))\\b"),
      ],
    ),
    Mode(
      className: 'type',
