...
final langLeaf = Mode(
  ...
  contains: <Mode>[
    Mode(
      match: ["#+", "([A-Za-z_][A-Za-z_0-9]*)?", "(?=\\()"],
      scope: <int, String>{1: 'punctuation', 2: 'keyword'},
      starts: Mode(
        contains: <Mode>[Mode(match: "\\:", scope: 'punctuation')],
      ),
      contains: <Mode>[Mode(ref: '~contains~0~contains~0')],
    ),
    Mode(
      match: ["#+", "([A-Za-z_][A-Za-z_0-9]*)?", ":?"],
      scope: <int, String>{1: 'punctuation', 2: 'keyword', 3: 'punctuation'},
    ),
  ],
);
