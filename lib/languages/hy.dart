...
final langHy = Mode(
  refs: {
    ...
    '~contains~1~contains~1~starts~contains~3': Mode(
      scope: 'comment',
      begin: "\\^\\{",
      end: "\\}",
      contains: <Mode>[
    ...
    '~contains~1~contains~1~starts~contains~6': Mode(
      ...
      contains: <Mode>[
        ...
        Mode(className: 'literal', begin: "\\b([Tt]rue|[Ff]alse|nil|None)\\b"),
        Mode(
          begin: "[a-zA-Z_\\-!.?+*=<>&#'][a-zA-Z_\\-!.?+*=<>&#'0-9/;:]*",
          relevance: 0,
        ),
    ...
    '~contains~1~contains~1~starts~contains~6~contains~7': Mode(
      className: 'number',
      begin: "[-+]?\\d+(\\.\\d+)?",
      relevance: 0,
    ),
    ...
    '~contains~1~contains~1~starts': Mode(
      endsWithParent: true,
      relevance: 0,
      contains: <Mode>[
        Mode(ref: '~contains~1'),
