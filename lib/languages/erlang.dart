...
final langErlang = Mode(
  ...
  contains: <Mode>[
    ...
    Mode(
      ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~7',
    ),
    Mode(
      ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~4',
    ),
    Mode(
      ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~5',
    ),
    QUOTE_STRING_MODE,
    Mode(
      ref:
    ...
    Mode(
      ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~8',
    ),
    Mode(
      ref:
          '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~8~contains~11~contains~1~contains~12',
