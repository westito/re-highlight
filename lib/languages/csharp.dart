...
final langCsharp = Mode(
  refs: {
              ...
              contains: <Mode>[
                ...
                Mode(
                  ...
                  contains: <Mode>[
                    ...
                    Mode(ref: '~contains~4~variants~1~contains~3~contains~1'),
                    Mode(
                      className: 'string',
                      begin: "@\"",
                      end: "\"",
      ...
      contains: <Mode>[
        Mode(
          ...
          contains: <Mode>[
            ...
            Mode(begin: "\"\""),
            Mode(
              ref: '~contains~4~variants~1~contains~3~contains~1~contains~3',
            ),
          ],
          illegal: "\\n",
        ),
    ...
    '~contains~4': Mode(
      variants: <Mode>[
                  ...
                  contains: <Mode>[
                    ...
                    Mode(
                      ...
                      contains: <Mode>[
                        ...
                        Mode(
                          ref: '~contains~4~variants~1~contains~3~contains~1',
                        ),
                        Mode(
                          className: 'string',
                          begin: "@\"",
        ...
        Mode(ref: '~contains~4~variants~1~contains~3~contains~1'),
        Mode(ref: '~contains~4~variants~1~contains~3~contains~2'),
        APOS_STRING_MODE,
        QUOTE_STRING_MODE,
      ],
    ),
  ...
  contains: <Mode>[
    ...
    Mode(ref: '~contains~4'),
    Mode(
      ref: '~contains~4~variants~1~contains~3~contains~1~contains~3~contains~5',
    ),
    Mode(
