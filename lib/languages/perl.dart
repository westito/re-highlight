  ...
  refs: {
    ...
    '~contains~3': Mode(
      ...
      contains: <Mode>[
        ...
        Mode(ref: '~contains~3~contains~4~contains~1~contains~10'),
      ],
    ),
    ...
    '~contains~3~contains~4~contains~1~contains~10': Mode(
      ...
      subLanguage: "mojolicious",
      contains: <Mode>[Mode(begin: "^@@.*", end: "\$", className: 'comment')],
    ),
  },
  name: "Perl",
  aliases: ["pl", "pm"],
