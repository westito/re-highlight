...
const blackMetalDarkFuneralTheme = {
  'root': TextStyle(
  ...
  'title': TextStyle(color: Color(0xff5f81a5)),
  'class-title': TextStyle(color: Color(0xff5f81a5)),
  'title.class_': TextStyle(color: Color(0xff5f81a5)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff5f81a5)),
  'code': TextStyle(color: Color(0xffd0dfee)),
  'addition': TextStyle(color: Color(0xffd0dfee)),
  'title.class_.inherited__': TextStyle(color: Color(0xffd0dfee)),
  'string': TextStyle(color: Color(0xffd0dfee)),
