...
const blackMetalBathoryTheme = {
  ...
  'title': TextStyle(color: Color(0xffe78a53)),
  'class-title': TextStyle(color: Color(0xffe78a53)),
  'title.class_': TextStyle(color: Color(0xffe78a53)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xffe78a53)),
  'code': TextStyle(color: Color(0xfffbcb97)),
  'addition': TextStyle(color: Color(0xfffbcb97)),
  'title.class_.inherited__': TextStyle(color: Color(0xfffbcb97)),
  'string': TextStyle(color: Color(0xfffbcb97)),
