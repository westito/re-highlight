...
const blackMetalKholdTheme = {
  ...
  'title': TextStyle(color: Color(0xff974b46)),
  'class-title': TextStyle(color: Color(0xff974b46)),
  'title.class_': TextStyle(color: Color(0xff974b46)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff974b46)),
  'code': TextStyle(color: Color(0xffeceee3)),
  'addition': TextStyle(color: Color(0xffeceee3)),
  'title.class_.inherited__': TextStyle(color: Color(0xffeceee3)),
  'string': TextStyle(color: Color(0xffeceee3)),
