...
const blackMetalImmortalTheme = {
  ...
  'title': TextStyle(color: Color(0xff556677)),
  'class-title': TextStyle(color: Color(0xff556677)),
  'title.class_': TextStyle(color: Color(0xff556677)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff556677)),
  'code': TextStyle(color: Color(0xff7799bb)),
  'addition': TextStyle(color: Color(0xff7799bb)),
  'title.class_.inherited__': TextStyle(color: Color(0xff7799bb)),
  'string': TextStyle(color: Color(0xff7799bb)),
