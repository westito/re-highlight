...
const blackMetalMardukTheme = {
  ...
  'title': TextStyle(color: Color(0xff626b67)),
  'class-title': TextStyle(color: Color(0xff626b67)),
  'title.class_': TextStyle(color: Color(0xff626b67)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff626b67)),
  'code': TextStyle(color: Color(0xffa5aaa7)),
  'addition': TextStyle(color: Color(0xffa5aaa7)),
  'title.class_.inherited__': TextStyle(color: Color(0xffa5aaa7)),
  'string': TextStyle(color: Color(0xffa5aaa7)),
