...
const blackMetalTheme = {
  ...
  'title': TextStyle(color: Color(0xffa06666)),
  'class-title': TextStyle(color: Color(0xffa06666)),
  'title.class_': TextStyle(color: Color(0xffa06666)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xffa06666)),
  'code': TextStyle(color: Color(0xffdd9999)),
  'addition': TextStyle(color: Color(0xffdd9999)),
  'title.class_.inherited__': TextStyle(color: Color(0xffdd9999)),
  'string': TextStyle(color: Color(0xffdd9999)),
