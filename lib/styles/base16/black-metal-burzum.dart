...
const blackMetalBurzumTheme = {
  ...
  'title': TextStyle(color: Color(0xff99bbaa)),
  'class-title': TextStyle(color: Color(0xff99bbaa)),
  'title.class_': TextStyle(color: Color(0xff99bbaa)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff99bbaa)),
  'code': TextStyle(color: Color(0xffddeecc)),
  'addition': TextStyle(color: Color(0xffddeecc)),
  'title.class_.inherited__': TextStyle(color: Color(0xffddeecc)),
  'string': TextStyle(color: Color(0xffddeecc)),
