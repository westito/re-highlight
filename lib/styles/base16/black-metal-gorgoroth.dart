...
const blackMetalGorgorothTheme = {
  ...
  'title': TextStyle(color: Color(0xff8c7f70)),
  'class-title': TextStyle(color: Color(0xff8c7f70)),
  'title.class_': TextStyle(color: Color(0xff8c7f70)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff8c7f70)),
  'code': TextStyle(color: Color(0xff9b8d7f)),
  'addition': TextStyle(color: Color(0xff9b8d7f)),
  'title.class_.inherited__': TextStyle(color: Color(0xff9b8d7f)),
  'string': TextStyle(color: Color(0xff9b8d7f)),
