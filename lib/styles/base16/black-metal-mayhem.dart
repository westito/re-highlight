...
const blackMetalMayhemTheme = {
  ...
  'title': TextStyle(color: Color(0xffeecc6c)),
  'class-title': TextStyle(color: Color(0xffeecc6c)),
  'title.class_': TextStyle(color: Color(0xffeecc6c)),
  'strong': TextStyle(fontWeight: FontWeight.bold, color: Color(0xffeecc6c)),
  'code': TextStyle(color: Color(0xfff3ecd4)),
  'addition': TextStyle(color: Color(0xfff3ecd4)),
  'title.class_.inherited__': TextStyle(color: Color(0xfff3ecd4)),
  'string': TextStyle(color: Color(0xfff3ecd4)),
